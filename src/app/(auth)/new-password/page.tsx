...
//       if (isDigit && index < otpRefs.current.length - 1) {
...
//           ref={ref}
//           type="text"
//           className="otp-input h-10 w-10 rounded border border-gray-400 text-center focus:outline-none"
//           maxLength={1}
//           value={otp[index]}
...
//     try {
//       const response = await fetch('http://35.175.36.153:3000/user/forgot-password', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
//         body: JSON.stringify({ email, password, confirmPassword, otp: otp.join('') }), // Add OTP to the request body
//       })

//       if (response.ok) {
//         console.log('Password reset successful')
//         window.location.href = '/auth/signin' // Redirect with window.location
//       } else {
...
//       <h1 className="my-5 text-center text-4xl font-semibold">New Password</h1>

//       <div className="mx-4 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
//         <div className="flex flex-wrap items-center">
//           <div className="hidden border-l-2 pl-2 xl:block xl:w-1/2">
...
//               {/* OTP Input */}
//               <label className="mb-2.5 block font-medium text-black dark:text-white">Enter 4-digit OTP</label>
...
//                 <input
//                   type="submit"
//                   className="w-full cursor-pointer rounded-lg border bg-primary p-4 text-white transition hover:bg-opacity-90"
//                   value="Submit"
//                 />
//               </div>
//             </form>
