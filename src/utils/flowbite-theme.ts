...
export const customFlowbiteThemeConfig: CustomFlowbiteTheme = {
  ...
  dropdown: {
    floating: {
      item: {
        base: 'flex w-full cursor-pointer items-center justify-start px-6 py-2 text-base text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-gray-200 dark:hover:bg-neutral-300 dark:hover:text-white dark:focus:bg-neutral-300 dark:focus:text-white',
      },
      base: 'z-10 w-fit divide-y divide-gray-100 rounded-[24px] shadow focus:outline-none',
      style: {
        auto: 'border border-gray-200 bg-white text-neutral-900 dark:border-none dark:bg-boxdark dark:text-white',
      },
    },
    content: 'px-0 py-6',
  },
